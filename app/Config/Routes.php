...
$routes->group('api', ['namespace' => 'App\Controllers\Api'], static function ($routes) {
    ...
    $routes->post('change-password-wo-cp', 'Users::change_password_without_current_password'); 
...
//notification api route
    ...
    $routes->get('get-milestones', 'Users::getMilestones');
    $routes->get('get-stages', 'Users::getStages');
    ...
    $routes->post('reminder/get', 'Reminder::get');
    $routes->post('reminder/delete', 'Reminder::deleteReminder');
    $routes->post('reminder/edit', 'Reminder::editReminder');
    $routes->get('reminder/getfcm', 'Reminder::getReminderFcm');

    //Content
    $routes->post('blogs/save-later', 'Content::saveForlater');
    $routes->post('blogs/get-save-later', 'Content::getSavedBlogs');
   $routes->post('content/file-upload', 'Content::uploadFile');
    //Specialists
     $routes->post('specialist/add-review', 'Users::addSpecialistReview');
     $routes->post('specialist/get-detail', 'Users::getSpecialistDetail');

     $routes->post('specialist/save_later', 'Specialist::saveLaterSpecialist');
     $routes->get('specialist/get_save_later', 'Specialist::getSaveLaterSpecialists');

      //user diet track  
    $routes->post('userEmotions', 'userDietChart::userEmotions');
    $routes->post('logYourNutrition', 'userDietChart::logYourNutrition');
    $routes->post('logBabyDetail', 'userDietChart::logBabyDetail');
    $routes->post('logYourActivity', 'userDietChart::logYourActivity');
    $routes->get('getHydration', 'userDietChart::getHydration');
    $routes->get('getMealsSnacks', 'userDietChart::getMealsSnacks');
    $routes->get('getFeeding', 'userDietChart::getFeeding');
    $routes->get('getWetDiapers', 'userDietChart::getWetDiapers');
    $routes->get('getHealth', 'userDietChart::getHealth');
    $routes->get('getemotions', 'userDietChart::getEmotions');
...
$routes->group('admin', ['namespace' => 'App\Controllers\Admin'], static function ($routes) 
{
    ...
    $routes->post('do_login', 'Admin::do_login');
