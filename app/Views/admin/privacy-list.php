...
<div class="page-content">
    <div class="container-fluid">
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Privacy</a></li>
        ...
        <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Terms Of Use</h4>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="customerList">
                            ...
                            <form id="edit_privacy" method="post" action="#" onsubmit="return edit_cookie(this , <?= $cookie_list['id']; ?>)" >
                                <div class="col-md-12 py-3">
                                    <div>
                                        <label>Title</label>
...
<script type="text/javascript">
    function edit_privacy(el , id) {
       $('.alert-danger').remove();
         $.ajax({
         url: '<?= base_url() ?>/Admin/Content_Management/edit_privacy',
         type: 'POST',
         cache:false,
         contentType: false,
         processData: false,
...
function edit_cookie(el , id) {
    $('.alert-danger').remove();
      $.ajax({
      url: '<?= base_url() ?>/Admin/Content_Management/edit_cookie',
      type: 'POST',
      cache:false,
      contentType: false,
      processData: false,
