        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Content SubCategory list</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Content SubCategory list</a></li>
                            <li class="breadcrumb-item active">Content SubCategory list</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Content SubCategory list</h4>
                            ...
                            <div class="row g-4 mb-3">
                                ...
                                <div class="table-responsive table-card mt-3 mb-1">
                                    <table class="table align-middle table-nowrap" id="example23">
                                        ...
                                        <?php if ($content_subcat): $i = 1; ?>
                                            <?php foreach ($content_subcat as $key => $value): ?>
                                                <tr>
                                                ...
                                                <td><?php 
                                               $catData =  $this->common_model->GetSingleData('content',array('id'=>$value['parent']),'id','desc');
                      ...
                      <div class="col-md-12 py-3">
                        ...
                        <div>
                            ...
                            <select class="form-control"  name="category" required="">
                              ...
                              <?php
                              foreach ($content_category as $key => $CatV) {
                                ?>
                      ...
                      <div>
                        ...
                        <div class="mt-3 modal-footer">
                            <button type="submit"  id="update<?= $value['id']; ?>" class="btn btn-success">Update</button>
                                    ...
                                    <div class="noresult" style="display: <?= ($content_subcat) ? 'none' : 'block' ?>">
...
function addSubCat(event) {
    ...
    $('.alert-danger').remove();
        ...
        $.ajax({
              url: '<?= base_url()?>/Admin/Content/add_Content_SubCategory',
              data: data,
              processData: false,
              contentType: false,
              type: 'POST',
 ...
 function edit_Content(el , id) {
    $('.alert-danger').remove();
      $.ajax({
      url: '<?= base_url() ?>/Admin/Content/edit_ContentsubCat',
      type: 'POST',
      cache:false,
      contentType: false,
      processData: false,
...
function deleteRow(id) {
    if(confirm('Are you sure ?')){
      $.ajax ({
          url: '<?= base_url()?>/Admin/Content/delete_ContentsubCat',
          data: {id:id},
          type: 'POST',
          dataType:'json',
          beforeSend: function() {        
