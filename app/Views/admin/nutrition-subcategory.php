        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Nutrition SubCategory</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Nutrition SubCategory</a></li>
                            <li class="breadcrumb-item active">Nutrition SubCategory</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Nutrition SubCategory list</h4>
                      </div><!-- end card header -->
                        <br>
                        <div class="row">
                            ...
                            <div class="row g-4 mb-3">
                                ...
                                <div class="table-responsive table-card mt-3 mb-1">
                                    <table class="table align-middle table-nowrap" id="example23">
                                        ...
                                        <?php if ($nutrition_subcategory): $i = 1; ?>
                                            <?php foreach ($nutrition_subcategory as $key => $value): ?>
                                                <tr>
                                                ...
                                                <td><?php  //$value['title']; 
                                                $category = $this->common_model->GetSingleData('nutrition_category',array('id'=>$value['parent']));
                                                echo $category['title'];
                                                ?></td>
                                                <td><p>
                ...
                <div class="modal-content">
                  ...
                  <!-- Modal Header -->
                   <div class="modal-header bg-light p-3">
                    <h4 class="modal-title p-0">Edit Nutrition SubCategory</h4>
                      ...
                      <div class="col-md-12 py-3">
                        ...
                        <div>
                          ...
                          <select class="form-control" name="category"  required>
                           ...
                           <?php 
                           foreach ($nutrition_category as $key => $catV) {
                             ?>
                      ...
                      <div>
                       ...
                       <div class="mt-3 modal-footer">
                            <button type="submit"  id="update<?= $value['id']; ?>" class="btn btn-success">Update</button>
                                    ...
                                    <div class="noresult" style="display: <?= ($nutrition_subcategory) ? 'none' : 'block' ?>">
    ...
    <div class="modal" id="addModal">                 
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <!-- Modal Header -->
                   <div class="modal-header bg-light p-3">
                    <h4 class="modal-title p-0">Add Nutrition SubCategory</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal"></button>
                  </div>
...
function addSubCategory(event) {
    ...
    $('.alert-danger').remove();
        ...
        $.ajax({
              url: '<?= base_url()?>/Admin/Nutrition/add_nutrition_subcategory',
              data: data,
              processData: false,
              contentType: false,
              type: 'POST',
 ...
 function edit_specialistsubcategory(el , id) {
    $('.alert-danger').remove();
      $.ajax({
      url: '<?= base_url() ?>/Admin/Nutrition/edit_Nutritionsubcategory',
      type: 'POST',
      cache:false,
      contentType: false,
      processData: false,
...
function deleteRow(id) {
    if(confirm('Are you sure ?')){
      $.ajax ({
          url: '<?= base_url()?>/Admin/Nutrition/delete_nutritionsubcategory',
          data: {id:id},
          type: 'POST',
          dataType:'json',
          beforeSend: function() {        
