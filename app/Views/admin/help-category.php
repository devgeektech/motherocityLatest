        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Help Category</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Help Category</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Help Category list</h4>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header bg-light p-3">
                <h4 class="modal-title p-0">Edit Help Category</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal"></button>
            </div>
                  
            <!-- Modal body -->
            <form id="edit_helpCategory" method="post" action="#" onsubmit="return edit_helpCategory(this , <?= $value['id']; ?>)" >
...
<div class="modal" id="addModal">                 
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <!-- Modal Header -->
            <div class="modal-header bg-light p-3">
                <h4 class="modal-title p-0">Add Help Category</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal"></button>
            </div>
...
function addCategory(event) {
    ...
    $('.alert-danger').remove();
        ...
        $.ajax({
              url: '<?= base_url()?>/Admin/Content_Management/add_help_category',
              data: data,
              processData: false,
              contentType: false,
              type: 'POST',
 ...
 function edit_helpCategory(el , id) {
    $('.alert-danger').remove();
      $.ajax({
      url: '<?= base_url() ?>/Admin/Content_Management/edit_helpCategory',
      type: 'POST',
      cache:false,
      contentType: false,
      processData: false,
...
function deleteRow(id) {
    if(confirm('Are you sure ?')){
      $.ajax ({
          url: '<?= base_url()?>/Admin/Content_Management/delete_help_category',
          data: {id:id},
          type: 'POST',
          dataType:'json',
          beforeSend: function() {        
