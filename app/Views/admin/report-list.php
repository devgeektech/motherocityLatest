                            ...
                            <div class="row g-4 mb-3">
                                ...
                                <div class="table-responsive table-card mt-3 mb-1">
                                    <table class="table align-middle table-nowrap" id="example23">
                                        ...
                                        <?php if ($report_list): $i = 1; ?>
                                            <?php foreach ($report_list as $key => $value): ?>
                                                <tr>
                                               
                                                <td>#<?= $i; ?></td>
                                                <td><?php //$value['name'];
                                                  $userdata = $this->common_model->GetSingleData('users',array('id'=>$value['user_id']),'id','desc');
                                                  echo $userdata['name'];
                                                 ?></td>
                                                <td><?php //$value['email']; 
                                                  echo $userdata['email'];
                                                ...
                                                <td><?= $value['subject']; ?></td>
                                                <td><?= $value['message']; ?></td>
                                                <?php $rep_category = $this->common_model->GetSingleData('report_category',array('id'=>$value['category'])) ?>
                                                <td><?=$rep_category['title']?></td>
                                               <!--   
                                               <td>
                                    ...
                                    <div class="noresult" style="display: <?= ($report_list) ? 'none' : 'block' ?>">
