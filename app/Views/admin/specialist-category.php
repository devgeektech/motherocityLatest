        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Specialist Category</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Specialist Category</a></li>
                            <li class="breadcrumb-item active">Specialist Category</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Specialist Category list</h4>
                        ...
                        <div id="customerList">
                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                <table class="table align-middle table-nowrap" id="example23">
                                    ...
                                    <?php if ($specialist_category): $i = 1; ?>
                                    <?php foreach ($specialist_category as $key => $value): ?>
                                        <tr>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header bg-light p-3">
                <h4 class="modal-title p-0">Edit Specialist Category</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal"></button>
            </div>
                  
            <!-- Modal body -->
            <form id="edit_specialistcategory" method="post" action="#" onsubmit="return edit_specialistcategory(this , <?= $value['id']; ?>)" >
                    ...
                    <div class="col-md-12 py-3">
                        ...
                        <div class="mt-3 modal-footer">
                            <button type="submit"  id="update<?= $value['id']; ?>" class="btn btn-success">Update</button>
                                    ...
                                    <div class="noresult" style="display: <?= ($specialist_category) ? 'none' : 'block' ?>">
...
<div class="modal" id="addModal">                 
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <!-- Modal Header -->
            <div class="modal-header bg-light p-3">
                <h4 class="modal-title p-0">Add Specialist Category</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal"></button>
            </div>
...
function addCategory(event) {
    ...
    $('.alert-danger').remove();
        ...
        $.ajax({
              url: '<?= base_url()?>/Admin/Specialist_category/add_specialist_category',
              data: data,
              processData: false,
              contentType: false,
              type: 'POST',
 ...
 function edit_specialistcategory(el , id) {
    $('.alert-danger').remove();
      $.ajax({
      url: '<?= base_url() ?>/Admin/Specialist_category/edit_specialistcategory',
      type: 'POST',
      cache:false,
      contentType: false,
      processData: false,
...
function deleteRow(id) {
    if(confirm('Are you sure ?')){
      $.ajax ({
          url: '<?= base_url()?>/Admin/Specialist_category/delete_Specialist_category',
          data: {id:id},
          type: 'POST',
          dataType:'json',
          beforeSend: function() {        
