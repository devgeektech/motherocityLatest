                ...
                <div class="modal-content">
                  ...
                  <!-- Modal Header -->
                   <div class="modal-header bg-light p-3">
                    <h4 class="modal-title p-0">Edit Blog Category</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal"></button>
                  </div>
                  
                  <!-- Modal body -->
                  <form id="edit_Blogcategory" method="post" action="#" onsubmit="return edit_Blogcategory(this , <?= $value['id']; ?>)" >
                        ...
                        <!-- <div>
                         ...
                         <div class="mt-3 modal-footer">
                            <button type="submit"  id="update<?= $value['id']; ?>" class="btn btn-success">Update</button>
                                    ...
                                    <div class="noresult" style="display: <?= ($blog_category) ? 'none' : 'block' ?>">
    ...
    <div class="modal" id="addModal">                 
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <!-- Modal Header -->
                   <div class="modal-header bg-light p-3">
                    <h4 class="modal-title p-0">Add Blog Category</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal"></button>
                  </div>
...
function addCategory(event) {
    ...
    $('.alert-danger').remove();
        ...
        $.ajax({
              url: '<?= base_url()?>/Admin/Blog/add_Blogcategory',
              data: data,
              processData: false,
              contentType: false,
              type: 'POST',
 ...
 function edit_Blogcategory(el , id) {
    $('.alert-danger').remove();
      $.ajax({
      url: '<?= base_url() ?>/Admin/Blog/edit_BlogCategory',
      type: 'POST',
      cache:false,
      contentType: false,
      processData: false,
