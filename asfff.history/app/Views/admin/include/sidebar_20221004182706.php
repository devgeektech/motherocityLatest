            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <?php endif ?>    
                        <?php if(CheckRoleAndPermission(2) || CheckRoleAndPermission(3) || CheckRoleAndPermission(4)) : ?>
                        <li class="nav-item">
                            ...
                            <div class="menu-dropdown collapse" id="userss" style="">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                    <?php if(CheckRoleAndPermission(2)) : ?>
                                        <a href="<?= base_url('') ?>/admin/verified_user" class="nav-link" data-key="t-analytics">Verified Specialist</a>
                                    <?php endif ?>
                                    <?php if(CheckRoleAndPermission(3)) : ?>
                                        <a href="<?= base_url('') ?>/admin/incoming_user" class="nav-link" data-key="t-analytics">Incoming Specialist</a>
                                    <?php endif ?>
                                    <?php if(CheckRoleAndPermission(4)) : ?>
                                        <a href="<?= base_url() ?>/admin/moms" class="nav-link" data-key="t-analytics">Moms</a>
                                    <?php endif ?>  
                                    </li>
                                </ul>
                            </div>
