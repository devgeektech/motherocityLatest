...
<head>
    ...
    <link rel="stylesheet" href="http://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.9.0/slick.min.css">
  <link rel="stylesheet" href="http://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.9.0/slick-theme.min.css">
        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="d-flex align-items-center">
                   <div class="d-md-none d-block"><img src="<?= base_url() ?>/assets/images/logo-mini.png" alt="" height="50"></div>
                   <div><button type="button" class="btn btn-sm px-3 fs-16 header-item vertical-menu-btn topnav-hamburger" id="topnav-hamburger-icon">
