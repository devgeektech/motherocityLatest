...
trait ResponseTrait
{
    ...
    protected $codes = [
        ...
        'conflict'                  => 200,
        'resource_gone'             => 200,
        'payload_too_large'         => 200,
        'unsupported_media_type'    => 200,
        'too_many_requests'         => 200,
        'server_error'              => 200,
        'unsupported_grant_type'    => 200,
        'not_implemented'           => 200,
    ];
    ...
    {
        return $this->fail($description, $this->codes['invalid_data'], 0, $message);
    }
