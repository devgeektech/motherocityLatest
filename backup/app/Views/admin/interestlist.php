...
<div class="page-content">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Interest</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Interest</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Interest list</h4>
                        </div><!-- end card header -->
                        <div class="card-body">
                            <div id="customerList">
                                            ...
                                            <?php foreach ($data as $key => $value): ?>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                              ...
                                                              <div class="modal-content">
                                                                ...
                                                                <!-- Modal Header -->
                                                                 <div class="modal-header bg-light p-3">
                                                                  <h4 class="modal-title p-0">Edit Interest</h4>
                                                                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal"></button>
                                                                </div>
                                                                
                                                                <!-- Modal body -->
                                                                <form id="edit_interest" method="post" action="#" onsubmit="return edit_interest(this , <?= $value['id']; ?>)" >
                                                        ...
                                                        <div class="remove">
                                                            <button class="btn btn-danger" id="delete_btns" onclick="delete_interest(<?= $value['id'] ?>)">Delete</button>
                                                        </div>
    ...
    <div class="modal" id="myModal">                 
                                        <div class="modal-dialog modal-dialog-centered">
                                          <div class="modal-content">
                                            ...
                                            <!-- Modal body -->
                                            <form id="add_interest" method="post" action="#" onsubmit="return add_interest()" >
                                                 <div class="modal-body">
                                                <div class="col-md-12 py-3">
                                                    <div>
                                                        <label>Title</label>
  ...
  $('.alert-danger').remove();
      ...
      $.ajax({
      url: '<?= base_url() ?>/Admin/Interest/addInterest',
      type: 'POST',
      cache:false,
      contentType: false,
      processData: false,
      data:new FormData($('#add_interest')[0]),
      dataType: 'json',
      beforeSend: function() {        
...
function edit_interest(el , id) {
    $('.alert-danger').remove();
      $.ajax({
      url: '<?= base_url() ?>/Admin/Interest/editInterest',
      type: 'POST',
      cache:false,
      contentType: false,
      processData: false,
...
function delete_interest(id) {
    ...
    {
        $.ajax({
      url: '<?= base_url() ?>/Admin/Interest/deleteInterest',
      type: 'POST',
      cache:false,
      data:{'id':id},
      dataType: 'json',
