            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                       ...
                       <li class="nav-item">
                            <a class="nav-link menu-link" href="#interest" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="interest">
                                <i class="ri-stack-line"></i> <span data-key="t-dashboards">Interest Management</span>
                            </a>
                            <div class="menu-dropdown collapse" id="interest" style="">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="<?= base_url() ?>/admin/interest" class="nav-link" data-key="t-analytics">View</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
<!--  -->
                        <li class="nav-item">
                         ...
                         <li class="nav-item">
                            <a class="nav-link menu-link" href="#carrier" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="carrier">
                                <i class="bx bx-category"></i> <span data-key="t-dashboards">Carrier Goals Management</span>
                            </a>
                            <div class="menu-dropdown collapse" id="carrier" style="">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="<?= base_url() ?>/admin/carrier" class="nav-link" data-key="t-analytics">View</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
